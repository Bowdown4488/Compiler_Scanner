...
JavaLetter:
		...
		~[u0000-u007FuD800-uDBFF] {this.wasJavaIdentiferStart()}
		 covers UTF-16 surrogate pairs encodings for U+10000 to U+10FFFF
		[uD800-uDBFF] [uDC00-uDFFF] {this.wasJavaIdentiferStartUTF16()}
	;
//fragment
JavaLetterOrDigit:
		[a-zA-Z0-9$_]  these are the java letters or digits below 0x7F
		 covers all characters above 0x7F which are not a surrogate
		~[u0000-u007FuD800-uDBFF] {this.wasJavaIdentiferPart()}
		 covers UTF-16 surrogate pairs encodings for U+10000 to U+10FFFF
		[uD800-uDBFF] [uDC00-uDFFF] {this.wasJavaIdentiferPartUTF16()}
    ;
*/
