...
public class SLexer extends Lexer {
	...
	public static final int
		STRING=1, WS=2, LINE_COMMENT=3, LPAREN=4, RPAREN=5, LBRACK=6, RBRACK=7, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"STRING", "WS", "LINE_COMMENT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			null, "STRING", "WS", "LINE_COMMENT", "LPAREN", "RPAREN", "LBRACK", "RBRACK", 
			"EQUALS", "SEMICO", "ASSIGN"
		};
	}
	...
	public static final String _serializedATN =
		...
		"\2@\n\3\2\2\2AB\7+\2\2B\f\3\2\2\2CD\7}\2\2D\16\3\2\2\2EF\7\177\2\2F\20"+
